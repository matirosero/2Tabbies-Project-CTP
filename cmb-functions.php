...
add_action( 'cmb2_admin_init', 'mro_register_gridsize_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function mro_register_gridsize_metabox() {
	$prefix = 'mro_project_gridsize_';
	...
	$cmb_project = new_cmb2_box( array(
		'id'            => $prefix . 'metabox',
		'title'         => esc_html__( 'Grid size', 'mro-project-ctp' ),
		'object_types'  => array( 'project' ), // Post type
		// 'show_on_cb' => 'yourprefix_show_if_front_page', // function should return a bool value
		'context'    => 'side',
		'priority'   => 'low',
	...
	$cmb_project->add_field( array(
		'name'         => esc_html__( 'Twice as big', 'mro-project-ctp' ),
		'desc'         => esc_html__( 'Only applies if featured image is square.', 'mro-project-ctp' ),
		'id'           => $prefix . '2x',
		'type' => 'checkbox',
	) );
}